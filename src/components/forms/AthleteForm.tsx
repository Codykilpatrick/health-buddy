    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-700 dark:to-blue-800 text-white rounded-t-2xl p-8 shadow-lg">
        <div className="text-center">
          <svg className="w-12 h-12 mx-auto mb-4" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
            <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <h2 className="text-3xl font-bold mb-2">Create Athlete Profile</h2>
          <p className="text-blue-100 dark:text-blue-200">Enter health information and emergency contacts</p>
        </div>
      </div>

      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-b-2xl shadow-xl p-8">
        {/* Personal Information */}
        <div className="mb-8">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center">
            <svg className="w-6 h-6 mr-3 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
          ...
          <div className="mt-6">
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Team/Organization</label>
            <input
              type="text"
              name="teamOrg"
        ...
        <div className="mb-8">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center">
            <svg className="w-6 h-6 mr-3 text-red-600 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
          ...
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                Allergies
                <span className="text-gray-500 dark:text-gray-400 font-normal ml-2">(comma-separated)</span>
              </label>
              <input
                type="text"
                name="allergies"
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Medical Notes</label>
              <textarea
                name="medicalNotes"
        ...
        <div className="mb-8">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center">
            <svg className="w-6 h-6 mr-3 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
